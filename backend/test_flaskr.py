...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        ...
        last_question = [question.format() for question in questions][-1]
        res = self.client().delete(f"/questions/{last_question.get('id')}")
        data = json.loads(res.data)
        question = Question.query.get(last_question.get('id'))
